...
#At the time of writing, got stuck and wasn't able to make progress at first, had to look this up between the comments.
	for line in fp:
...
#There are some problems where it repeats similar words in edge cases.	
